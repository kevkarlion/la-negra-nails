...
export const ButtonBorder: React.FC<ButtonLinkProps> = ({
  ...
  return (
    <Link
      href={href}
      className="font-title  w-[19rem] h-6 relative inline-flex items-center justify-center px-5 py-2.5 overflow-hidden text-sm font-medium text-pink-500 border-2 border-pink-500 rounded-lg group transition-all duration-300 ease-in-out"
    >
