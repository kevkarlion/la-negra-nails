...
export const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Título del servicio */}
      <h3 className="text-xl font-sans font-semibold mb-2 text-secondary-pinkWhite">{title}</h3>

      {/* Descripción */}
      <p className="w-2/3 font-sans text-black font-light  text-sm z-20">{description}</p>
    </div>
  );
};
